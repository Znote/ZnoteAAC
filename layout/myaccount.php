...
if ($render_page) {
	...
	<div id="myaccount">
		<h1>My account</h1>
		<p>Welcome to your account page, <font color="lime"><strong><?php if ($config['ServerEngine'] !== 'OTHIRE') echo $user_data['name']; else echo $user_data['id']; ?></font></strong><br>
			<div class="inner">
		<?php if ($config['ServerEngine'] !== 'OTHIRE') {
				if ($user_data['premdays'] != 0) {
					...
					echo 'You are <font color="red">free</font> account.';
				}
			} else {
			...
			?>
			<center><h4 style="color:orange"> Admin Panel </h4></center>
			<hr>
			<table>
			<tr><td><a href="admin.php" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Admin Page" class="btn btn-primary btn-block"></a></a></td>
				<td><a href="changelog.php" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Admin Changelog" class="btn btn-primary btn-block"></a></a></td>
			
			<td><a href="admin_news.php" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Admin Create News" class="btn btn-primary btn-block"></a></a></td>

			<td><a href="admin_gallery.php" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Admin Gallery" class="btn btn-primary btn-block"></a></a>

			<td><a href="admin_skills.php" class="btn btn-primary btn-block">
			<input id="submit_button" type="submit" value="Admin Skills" class="btn btn-primary btn-block"></a></a>
			
			<td><a href="admin_reports.php" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Admin Reports" class="btn btn-primary btn-block"></a></a>
		
			<td><a href="admin_helpdesk" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Admin Tickets" class="btn btn-primary btn-block"></a></a>

			<td><a href="admin_shop.php" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Admin Shop" class="btn btn-primary btn-block"></a>
		
			<td><a href="admin_auction.php" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Admin Auction" class="btn btn-primary btn-block"></a>
				<td><a href="forum.php?cat=4" class="btn btn-primary btn-shiny btn-block">
				<input id="submit_button" type="submit" value="Feedback" class="btn btn-primary btn-block"></a>
</tr></table>
			<?php
			$new = 0;
			...
			<td><a href="createcharacter.php" class="btn btn-primary btn-block"><input id="submit_button" type="submit" value="Create Character" class="btn btn-primary btn-block">
				</a>

			<td><a href="changepassword.php" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Change Password" class="btn btn-primary btn-block"></a>

			<td><a href="settings.php" class="btn btn-primary btn-block">
			<input id="submit_button" type="submit" value="Settings" class="btn btn-primary btn-block"></a>
			
			<td><a href="logout.php" class="btn btn-primary btn-block">
				<input id="submit_button" type="submit" value="Logout" class="btn btn-primary btn-block"></a>
		</tr></table>
	</div>
